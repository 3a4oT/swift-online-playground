...
/// Handle all Socket Paths
///
/// - Parameter server: WebSocketServer
public func handleWebSockets(_ server: NIOWebSocketServer) {
    server.get("lsp") { socket, request in
        ...
        socket.onText { socket, text in
            ...
            // LSP over WS Requests printed here
            print(text)
            
            // Use to send data `socket.send(<#T##binary: Data##Data#>)`
        }
    }
}
