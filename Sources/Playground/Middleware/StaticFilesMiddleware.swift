...
public final class StaticFilesMiddleware: Middleware, ServiceType {
  
    /// See `ServiceType`.
    public static func makeService(for container: Container) throws -> StaticFilesMiddleware {
